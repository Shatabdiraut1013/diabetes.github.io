import Ergophen from '../images/es.jpg'
import Dehydroepiandrosterone from '../images/de.jpg'
import Eicosapentaenoicacid from '../images/fen.jpg'
import Estrogen from '../images/ev.jpg'
import Estropipate from '../images/est.jpg'
import FemHRT from '../images/fem.png'
import Miprogen from '../images/mip.jpg'

const womenhealth = [
    {
        imgsrc: "Ergophen",
        title: "Ergophen",
        indication: "This medication is a synthetic estrogen, prescribed for treating the symptoms of menopause, deficiency in ovary function and prostate cancer.",
        dosage: "Dosage is based on patient’s condition.",
        sideEffects: "Most Common: Blood clot, severe allergic reactions, changes in menstrual cycle and lump in breast region. Gastrointestinal: Loss of appetite, nausea and vomiting. Skin: Pimples and discoloration of skin. Central Nervous System: Headache, dizziness and depression.",
        price: 300,
    },
    {
        imgsrc: "Dehydroepiandrosterone",
